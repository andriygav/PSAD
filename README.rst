...
- Зачет будет 23.05.2023 во время лекции и семинара. У кого по результатам лаб и КР будет отлично, то можно получить автоматом оценку. В случае хора и уда сдача будет проходить на паре. В случае автомата ЯВКА НА ЗАЧЕТ ОБЯЗАТЕЛЬНА, для проставления оценки.
- Предварительные оценки за курс в `google таблице <https://docs.google.com/spreadsheets/d/1XtXmjm83_EbsyMuj-0k8du24lldFqwqhwfXSOMJcG7k/edit?usp=sharing>`_. В случае если Вас нет в таблице, но должны там быть --- пишите, в случае если Вы есть, но там быть не должны также пишите.
